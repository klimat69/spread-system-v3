export const ru = {
  ...
  accountBalance: "Баланс MEXC",
  accountBalanceHint: "Счёт по API-ключам (не Paper). Обновляется после сохранения настроек.",
  accountBalanceUnavailable: "Укажите API Key и Secret, затем сохраните настройки.",
  accountBalanceError: "Не удалось получить баланс",
  accountQuoteAvailable: "Доступно",
  accountQuoteTotal: "Всего",
  accountBaseBalance: "Монета пары",
  accountPosition: "Позиция",
  accountUnrealizedPnl: "Нереализ. P/L",
  apiKey: "API Key",
  ...
  liveAnalytics: "Аналитика Live",
  liveAnalyticsHint: "Ордера бота на MEXC (лимитные заявки и исполнения).",
  noLiveOrders: "Пока нет ордеров — включите Live, сохраните ключи, Старт и автоторговлю.",
  liveOrdersTotal: "Ордеров",
  liveOrdersOpen: "открыто",
  liveOrdersFilled: "исполнено",
  liveOrdersCancelled: "отменено",
  liveFillsTotal: "Исполнений на бирже",
  liveFees: "комиссия",
  liveColPrice: "Цена",
  liveColSize: "Объём",
  liveColStatus: "Статус",
  liveTableCount: "В таблице ордеров",
